...
export default function NotFound () {
  return (
    <div className='flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-16 gap-16 lg:gap-28'>
      ...
      <div className='w-full lg:w-1/2'>
        ...
        <Link to={path.home} className='w-full lg:w-auto my-4 border rounded-md px-1 sm:px-16 py-5 bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50'>
          Go back to Home
        </Link>
      </div>
    </div>
